        ...
        @endif
          ...
          @csrf
            <div class="mb-4">
              <div class="input-group">
                <span class="input-group-text back-clr-input">
                  <img src="{{ asset('assets/img/kodetech/Email.png') }}" alt="Email Icon" style="width: 20px;" class="input-icon">
                </span>
                <input type="email" id="email" name="email" class="form-control input-height login-palceholder" placeholder="login@admin.lk" required>
                @error('email')
            ...
            <div class="mb-3">
              <div class="input-group">
                <span class="input-group-text back-clr-input">
                  <img src="{{ asset('images/KeySecurity.png') }}" alt="Email Icon" style="width: 25px;" class="input-icon">
                </span>
            ...
            <button type="submit" class="btn btn-enter w-100" style="margin-bottom: 40px;">LOGIN</button>
          </form>
        </div>
      </div>
    </div>
