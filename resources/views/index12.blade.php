@extends('layout.layout1',['bgColor'=> 'bg-[#FEF7E6]'])
...
<div class="flex items-center gap-6">
    <a href="{{ url('login') }}" class="btn-text hidden hover:text-ColorBluePurple sm:inline-block">Login</a>
        ...
        <div class="pb-[60px] pt-28 md:pb-20 md:pt-36 lg:pb-[100px] lg:pt-[150px] xxl:pb-[120px] xxl:pt-[185px]">
            ...
            <div class="container-default">
                ...
                <div class="grid items-center justify-center gap-[60px] md:grid-cols-[1fr_minmax(0,_0.6fr)]">
                    ...
                    <!-- Hero Image Block -->
                    <div class="relative">
                        <img src="{{ asset('assets/img/th-12/hero-img.png') }}" alt="hero-img" width="455" height="548" data-jos_animation="zoom-in-down" class="mx-auto md:rotate-[5deg]" />

                        <!-- Hero Image Shape - 1 -->
                        <img src="{{ asset('assets/img/elements/hero-12-shape-1.svg') }}" alt="hero-12-shape-1" width="56" height="81" class="absolute -left-20 bottom-0 hidden md:inline-block lg:-left-28" />
                        <!-- Hero Image Shape - 2 -->
                        <img src="{{ asset('assets/img/elements/hero-12-shape-2.svg') }}" alt="hero-12-shape-2" width="55" height="68" class="absolute -right-16 -top-8 hidden md:inline-block" />
                    </div>
                    <!-- Hero Image Block -->
                </div>
                <!-- Hero Area -->
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-[30px] rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10 pr-[30px] lg:flex-row">
                            <div class="h-auto w-[74px]">
                                <img src="{{ asset('assets/img/icons/icon-black-home-12-feature-1.svg') }}" alt="icon-black-home-12-feature-1" width="75" height="81" class="h-auto w-full" />
                            </div>
                            <div class="flex-1">
                                ...
                                <a href="#">
                                    <img src="{{ asset('assets/img/icons/icon-black-arrow-right.svg') }}" alt="icon-black-arrow-right" width="31" height="20" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="jos" data-jos_delay="0.3">
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-[30px] rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10 pr-[30px] lg:flex-row">
                            <div class="h-auto w-[74px]">
                                <img src="{{ asset('assets/img/icons/icon-black-home-12-feature-2.svg') }}" alt="icon-black-home-12-feature-2.svg" width="75" height="66" class="h-auto w-full" />
                            </div>
                            <div class="flex-1">
                                <div class="mb-4 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                ...
                <div class="jos" data-jos_delay="0.6">
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-[30px] rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10 pr-[30px] lg:flex-row">
                            <div class="h-auto w-[74px]">
                                <img src="{{ asset('assets/img/icons/icon-black-home-12-feature-3.svg') }}" alt="icon-black-home-12-feature-3.svg" width="75" height="58" class="h-auto w-full" />
                            </div>
                            <div class="flex-1">
                                <div class="mb-4 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                ...
                <div class="jos" data-jos_delay="0.3">
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-[30px] rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10 pr-[30px] lg:flex-row">
                            <div class="h-auto w-[74px]">
                                <img src="{{ asset('assets/img/icons/icon-black-home-12-feature-4.svg') }}" alt="icon-black-home-12-feature-4.svg" width="75" height="79" class="h-auto w-full" />
                            </div>
                            <div class="flex-1">
                                <div class="mb-4 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                ...
                <div class="grid items-center gap-10 md:grid-cols-[0.7fr_minmax(0,_1fr)] lg:gap-24 xl:gap-[135px] xxl:gap-[182px]">
                        ...
                        <ul class="mt-8 flex flex-col gap-y-9 lg:mt-[50px]">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-1.svg') }}" alt="icon-purple-home-12-content-1" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-2.svg') }}" alt="icon-purple-home-12-content-2" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-3.svg') }}" alt="icon-purple-home-12-content-3.svg" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                    ...
                    <div class="jos order-2 md:order-1" data-jos_animation="fade-left">
                        <div class="mx-auto w-[70%] md:w-full">
                            <img src="{{ asset('assets/img/th-12/content-img-1.png') }}" alt="content-img-1" width="456" height="548" class="h-auto w-full -rotate-[5deg]" />
                        </div>
                    </div>
                    <!-- Content Block Right -->
                </div>
        ...
        <div class="container-default">
            ...
            <div class="jos">
                <div class="relative flex items-center justify-center">
                    <img src="{{ asset('assets/img/th-12/video-img.png') }}" alt="video-img" width="1296" height="600" class="h-auto w-full" />
                    <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=3nQNiWdeH2Q" class="group group absolute flex items-center justify-center" aria-label="video-play">
                        <img src="{{ asset('assets/img/icons/icon-purple-video-btn.svg') }}" alt="icon-purple-video-btn" width="126" height="120" class="h-auto w-16 md:h-auto md:w-24 lg:h-auto lg:w-[126px]" />
                    </a>
                </div>
            </div>
            <!-- Video Block -->
                ...
                <div class="grid items-center gap-10 md:grid-cols-[1fr_minmax(0,_0.7fr)] lg:gap-24 xl:gap-[135px] xxl:gap-[182px]">
                    ...
                    <div class="jos" data-jos_animation="fade-right">
                        ...
                        <ul class="mt-8 flex flex-col gap-y-9 lg:mt-[50px]">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-4.svg') }}" alt="icon-purple-home-12-content-4" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-5.svg') }}" alt="icon-purple-home-12-content-5" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                            ...
                            <li class="flex gap-x-5 font-Sora text-xl font-semibold text-[#0E0E0E] lg:text-2xl">
                                <div class="h-auto w-9">
                                    <img src="{{ asset('assets/img/icons/icon-purple-home-12-content-6.svg') }}" alt="icon-purple-home-12-content-6.svg" width="35" height="35" class="h-auto w-full" />
                                </div>
                                <div class="flex-1">
                    ...
                    <div class="jos" data-jos_animation="fade-left">
                        <div class="mx-auto w-[70%] md:w-full">
                            <img src="{{ asset('assets/img/th-12/content-img-2.png') }}" alt="content-img-2" width="456" height="548" class="h-auto w-full rotate-[5deg]" />
                        </div>
                    </div>
                    <!-- Content Block Right -->
                </div>
...
<div class="overflow-hidden bg-[#0E0E0E] py-5 font-Sora text-3xl font-semibold uppercase leading-[1.4] tracking-[1px] text-[#FEF7E6]">
    ...
    <div class="horizontal-slide-from-right-to-left flex gap-x-[30px]">
        ...
        <img src="{{ asset('assets/img/icons/icon-rum-swizzle-dial-star.svg') }}" alt="dial-star" width="37" height="35" />
        <span class="flex whitespace-nowrap">The best AI tool to get your perfect photo
        </span>
        <img src="{{ asset('assets/img/icons/icon-rum-swizzle-dial-star.svg') }}" alt="dial-star" width="37" height="35" />
        <span class="flex whitespace-nowrap">The best AI tool to get your perfect photo
                    ...
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-y-10 rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10">
                            <div class="h-auto w-16">
                                <img src="{{ asset('assets/img/icons/icon-purple-quote.svg') }}" alt="icon-purple-quote" width="64" height="60" class="h-auto w-full" />
                            </div>
                            ...
                            <div class="flex items-center gap-x-[17px]">
                                <div class="h-[60px] w-[60px] overflow-hidden rounded-[50%] border-2 border-[#0E0E0E]">
                                    <img src="{{ asset('assets/img/th-12/testimonial-user-img-1.png') }}" alt="testimonial-user-img-1" width="60" height="60" class="h-full w-full" />
                                </div>
                ...
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="0.3">
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-y-10 rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10">
                            ...
                            <div class="flex items-center gap-x-[17px]">
                                <div class="h-[60px] w-[60px] overflow-hidden rounded-[50%] border-2 border-[#0E0E0E]">
                                    <img src="{{ asset('assets/img/th-12/testimonial-user-img-2.png') }}" alt="testimonial-user-img-2" width="60" height="60" class="h-full w-full" />
                                </div>
                                <div class="text-xl font-semibold capitalize text-[#0E0E0E]">
                                    Adam Jonney
                ...
                <div class="jos" data-jos_animation="flip-left" data-jos_delay="0.6">
                    <div class="hover-solid-shadow h-full">
                        <div class="flex h-full flex-col gap-y-10 rounded-[10px] border-2 border-[#0E0E0E] bg-[#FEF7E6] p-10">
                            ...
                            <div class="flex items-center gap-x-[17px]">
                                <div class="h-[60px] w-[60px] overflow-hidden rounded-[50%] border-2 border-[#0E0E0E]">
                                    <img src="{{ asset('assets/img/th-12/testimonial-user-img-3.png') }}" alt="testimonial-user-img-3" width="60" height="60" class="h-full w-full" />
                                </div>
                                <div class="text-xl font-semibold capitalize text-[#0E0E0E]">
                                    Robert Mack
        ...
        <div class="container-default">
            ...
            <div class="grid items-center gap-x-6 gap-y-10 lg:grid-cols-[1fr_minmax(0,_0.8fr)] xxl:gap-x-[134px]">
                ...
                <div class="jos" data-jos_animation="fade-right">
                    ...
                    <a href="{{ url('contact') }}" class="group relative z-10 inline-block">
                        <div class="btn is-large rounded-[3px] border-2 border-[#0E0E0E] bg-ColorBluePurple text-white">
                            Ask You Questions
                        </div>
                        <div class="absolute inset-0 -z-10 translate-x-[5px] translate-y-[5px] rounded-[3px] bg-[#0E0E0E] transition-all duration-300 ease-linear group-hover:translate-x-0 group-hover:translate-y-0"></div>
...
<section class="section-cta">
    ...
    <div class="container-default">
        <div class="relative z-10 rounded-[10px] bg-[#FFD372]">
            ...
            <!-- Background Shape -->
            <img src="{{ asset('assets/img/elements/home-12-cta-shape.svg') }}" alt="home-12-cta-shape.svg" width="72" height="106" class="absolute right-32 top-8 -z-10 hidden xl:inline-block" />
        </div>
    </div>
    <!-- Section Container -->
    <!-- Section Background -->
