                        ...
                        <div class="grid items-center gap-10 lg:grid-cols-2 lg:gap-10 xl:gap-10">
                            ...
                            <div class="jos order-2 md:order-2" data-jos_animation="fade-right">
                                ...
                                <p style="color: #000 !important" class="mb-5">
                                    ...
                                    a rich legacy spanning over 14 years.
                                </p>
                                {{-- <hr class="mb-5" /> --}}
                                <p style="color: #000 !important">
                                    ...
                                    approach and cutting-edge technologies always help for a better experience.Kode Tech
                                    (Pvt) Ltd is a well-established and renowned software development company with a rich
                                    legacy spanning over 14 years.
                                    Our extensive expertise has earned us a strong foothold in 15 international markets,
                                    where we’ve successfully delivered over 1,500 projects. Our innovative and creative
                                    approach and cutting-edge technologies always help for a better experience.Our
                                    innovative and creative approach and cutting-edge technologies always help for a better
                                    experience.Our innovative and creative approach and cutting-edge technologies always
                                    help for a better experience.Our innovative and creative approach and cutting-edge
                                    technologies always help for a better experience.
                                </p>
                            </div>
                            <!-- Content Block Left -->
                            <!-- Content Block Right -->
                            <div class="jos relative order-1 md:order-1" data-jos_animation="fade-left">
                                ...
                                <img src="{{ asset('assets/img/kodetech/about-content-image.png') }}" alt="content-img-1"
                                    width="523" height="450" class="h-auto w-full rounded-[10px] shadow shadow-lg" />
                            </div>
                            <!-- Content Block Right -->
                        </div>
                        <!-- Content Area Single -->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="flex flex-col rounded-[10px] bg-white text-ColorBlack"
                                        style="height: auto; width: max-content; display: flex; justify-content: center; align-items: center;">
                                        <img src="{{ asset('assets/img/kodetech/partners/Logo 11.png') }}"
                                            alt="icon-green-star" width="100" height="80" class="img-fluid"
                                            style="width: 100%;" />
                                    </div>
                                </div>
                                    ...
                                    <div class="jos mb-6 break-inside-avoid shadow rounded-md">
                                        <div class="flex flex-col rounded-[10px] bg-white p-6 text-ColorBlack sm:p-[30px]">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <img src="{{ asset('storage/' . $testimonial->testimonial_client_image) }}"
                                                    alt="testimonial-avater-1" width="60" height="60"
