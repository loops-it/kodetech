        ...
        <div class="section-space">
            ...
            <div class="container-default">
                ...
                <div class="mx-auto max-w-[1080px]">
                    ...
                    {{-- <img src="{{$services->service_image }}" alt="{{$services->service_name }}" class="mb-10 h-auto w-full rounded-[10px]" /> --}}
                    <img src="{{ asset('storage/' . $services->service_image) }}" alt="{{ $services->service_name }}" class="mb-10 h-auto w-full rounded-[10px]" />
                    <!-- Service Rich Text -->
                    <div class="rich-text">
